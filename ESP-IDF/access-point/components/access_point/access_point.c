...
// ========================================================================================================
/**
 * @brief Manipulador de requisições HTTP para /led/on
 * @param req Requisição HTTP recebida
 * @return ESP_OK se a requisição foi tratada com sucesso
 */
...
// ========================================================================================================
/**
 * @brief Manipulador de requisições HTTP para /led/off
 * @param req Requisição HTTP recebida
 * @return ESP_OK se a requisição foi tratada com sucesso
 */
...
void start_webserver(void) {
    ...
    if (httpd_start(&server, &config) == ESP_OK) {
        ...
        //---registra o manipulador para /led/on---
        ...
        //---registra o manipulador para /led/off---
